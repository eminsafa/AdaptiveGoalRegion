...
def agr_new(poses: np.ndarray, labels: np.ndarray) -> np.ndarray:
    rotate = False
    return_euler = False
    ...
    indices, global_labels = generate_indices_array_new(labels, positions, orientations)
